...
namespace DAL.Common
{
    ...
    public class CCPRestSDK
    {
        ...
        public static CCPRestSDK GetInstance()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["CCPRestSDKRestURL"];
            string port = System.Configuration.ConfigurationManager.AppSettings["CCPRestSDKRestURLPort"];
            string appID = System.Configuration.ConfigurationManager.AppSettings["CCPRestSDKAppID"];
