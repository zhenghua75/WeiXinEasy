...
namespace DAL.Album
{
    ...
    {
        public const string TABLE_NAME = "PA_UserPhoto";

        /// <summary>
        /// 添加用户相册照片
        /// </summary>
        /// <param name="info"></param>
        public void Insert(UserPhoto info)
        {
        ...
        public DataSet GetPhotoList(string strWhere)
        {
            ...
            strSql.Append(" FROM PA_UserPhoto ");
        ...
        /// <returns></returns>
        public DataSet GetUserPhoto(string strListID)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            strSql.Append(" LEFT JOIN PA_UserPhoto b ON (b.AddTime > a.BeginTime AND b.AddTime < a.EndTime AND b.SiteCode = a.SiteCode) ");
        ...
        public DataSet GetUserThumb(string strThumbID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" SELECT * ");
            strSql.Append(" FROM PA_UserPhoto a ");
            strSql.Append(" WHERE a.ID = @ID ");
            strSql.Append(" AND [State] = 1 ");
            IList<System.Data.SqlClient.SqlParameter> paras = new List<System.Data.SqlClient.SqlParameter>()
                {
        ...
        /// <param name="strThumbID">相册列表ID</param>
        /// <returns></returns>
        public DataSet GetMyThumb(string strThumbID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" SELECT * ");
            strSql.Append(" FROM PA_UserPhoto a ");
        ...
        /// <param name="strThumbID">相册列表ID</param>
        /// <returns></returns>
        public DataSet DelMyThumb(string strThumbID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" DELETE FROM PA_UserPhoto ");
        ...
        /// <param name="strListID">相册列表ID</param>
        /// <returns></returns>
        public DataSet GetMyPhoto(string strSiteCode,string strOpenID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" SELECT *  ");
            strSql.Append(" FROM dbo.PA_UserPhoto ");
