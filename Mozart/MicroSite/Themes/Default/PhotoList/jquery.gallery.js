$(function () {
    ...
    */
    function loadThumbs() {
        ...
        var url = 'Themes/PhotoList/ajax/thumbs.aspx?album=' + album;
        $.get(url, function (data) {
    ...
    */
    ...
    function loadPhoto($thumb) {
        ...
        $('<img/>').load(function () {
            ...
            //var url = "<a href='Themes/PhotoList/ajax/thumbsOK.aspx?thumb=" + $thumb.attr('title') + "'>ÔÞÒ»¸ö</a>";
            var url = "<a href='#' onclick='Foo(\"" + $thumb.attr('title') + "\")'><img src='Themes/PhotoList/themes/img/ok.gif' alt='' /></a>";
            $('#description').empty().html(url);
            $('#prev,#next').show();
