var iTemplate = (function () {
    ...
    a.fn = a.prototype = {
        init: function (b, d) {
            var c = this; this.xhr = new XMLHttpRequest();
            this.url = b; this.type = { get: "GET", post: "POST" }[d.type && d.type.toLowerCase()] || "GET";
            ...
            var b = this; b.xhr.open(this.type, this.url, this.async);
            b.xhr.setRequestHeader("common", JSON.stringify({
                platform: "HTML5",
                author: "Eric_wu", time: +new Date()
            }));
            b.xhr.setRequestHeader("X-Requested-With", "XMLHttpRequest");
            b.xhr.upload.onprogress = function (d) {
                if (d.lengthComputable) {
                    var c = (d.loaded / d.total) * 100; if (b.onprogress) { b.onprogress.call(d, c) }
                }
                ...
                b.xhr.timer = setTimeout(function () {
                    b.xhr.abort(); b.callback.call(b, {
                        result: 0, message: "请求超时"
                    });
                    clearTimeout(b.xhr.timer)
                }, b.timeout)
            } b.xhr.send(this.formData); return b
        }
    }; a.fn.init.prototype = a.fn; a.serializeFormData = function (c) {
        var d = new FormData(); for (var b in c) { d.append(b, c[b]) } return d
    };
    return a
})(this);