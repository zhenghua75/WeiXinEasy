<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PubSecHand.aspx.cs"  Inherits="Mozart.PalmShop.ShopCode.PubSecHand" EnableEventValidation="false" %>
				...
				<div class="table-responsive" id="product_info">
				  <table class="table">
				    ...
				    <tr>
				    	...
				    	<td class="col-xs-9">
                            <input type="text" id="price" runat="server" onkeyup="clearNoNum(this)" />
				    	</td>
				    </tr>
                      <tr>
