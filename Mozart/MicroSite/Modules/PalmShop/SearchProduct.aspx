<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchProduct.aspx.cs" Inherits="Mozart.PalmShop.ShopCode.SearchProduct" %>
		...
		<div class="container-fluid Product_List">
            <asp:Repeater ID="Repeater1" runat="server">
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
					<h4><a href='Product_detail.aspx?pid=<%#Eval("ID") %>'>
                        <%#Eval("ptitle").ToString().Length>10?Eval("ptitle").ToString().Substring(0,10)+"..":Eval("ptitle") %>
					    </a></h4>
					<%--<p>¥<%#Eval("price") %>元</p>--%>
				</div>
			</div>
