...
{
    public partial class Mylikelist : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    {
                        JQDialog.SetCookies("pageurl", "../../Comment/Mylikelist.aspx?fid=" + strfid, 2);
        ...
        public void getTemplate()
        {
            ...
            int topicCount = 0;
            DataSet topiclistds = topicDal.GetTopicByLikeOrLove(" and a.[UID]='" + strUid + 
                "' and d.Tlike=1 and a.FID='"+strfid+"' ",0);
            ...
            #endregion
            string text = System.IO.File.ReadAllText(Server.MapPath("HtmlPage/Mylikelist.html"));
