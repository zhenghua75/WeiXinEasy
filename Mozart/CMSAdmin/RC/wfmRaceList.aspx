<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmRaceList.aspx.cs" Inherits="Mozart.CMSAdmin.RC.wfmRaceList" %>
	...
	<script type="text/javascript">
	    function AddFunction() {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:RC/wfmRaceAdd.aspx',
	            lock: true,
	            close: function () {
	    ...
	    function UpdateArticle(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:RC/wfmRaceUpdate.aspx?action=update&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
	    ...
	    function ShowArticle(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:RC/wfmRaceUpdate.aspx?action=show&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
			...
			<table>
				<tr>
                    ...
                    <td>
                        ...
                        <input type="button" value="添加摇一摇" onclick="AddFunction()" />
                    </td>
				</tr>
			</table>
		</asp:Panel>
					...
					<tr style="background-color:#FAF3DC">  
						...
						<td>
                            <ul>
                                ...
                                <li><a target="_blank" href='../../WXWall/MoveRace.aspx?rid=<%#Eval("ID") %>'>查看赛事</a>&nbsp;|&nbsp;</li>
                                <li><a href="#" onclick="UpdateArticle('<%#Eval("ID") %>');">修改</a>&nbsp;|&nbsp;</li>
                                <li><a href="#" onclick="AdminBizControlConfirm('wfmRaceAdmin.aspx?action=del&id=<%#Eval("ID") %>');">删除</a></li>
                            </ul>
						</td>
					</tr>
			</ItemTemplate>
