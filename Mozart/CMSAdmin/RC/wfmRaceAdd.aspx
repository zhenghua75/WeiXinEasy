<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmRaceAdd.aspx.cs" ValidateRequest="false" EnableEventValidation="false" Inherits="Mozart.CMSAdmin.RC.wfmRaceAdd" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="Rtitle" runat="server" Width="800px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">活动二维码：</td>
                        <td align="left">
                            <div style="overflow: hidden;">
                                <input type="file" id="file0" runat="server" />&nbsp;建议尺寸500x450
                            </div>
                            <div>
                    ...
                    <tr>
                        <td align="right">摇动阀值：</td>
                        <td align="left">
                            <asp:TextBox ID="movenum" runat="server" ToolTip="该值一般为3000" 
