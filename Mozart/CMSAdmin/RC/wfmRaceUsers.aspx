<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmRaceUsers.aspx.cs" Inherits="Mozart.CMSAdmin.RC.wfmRaceUsers" %>
		...
		<asp:Panel ID="Panel1" runat="server" Height="31px" HorizontalAlign="Center">
			<table>
				<tr>
                    ...
                    <td>赛事名称：</td>
					<td>
						<asp:DropDownList ID="ddlRaceList"  runat="server">
                    ...
                    <td>获奖状态：</td>
					<td>
						<asp:DropDownList ID="ddliswin"  runat="server">
                            <asp:ListItem Text="--全部--" Value=""></asp:ListItem>
                            <asp:ListItem Text="未获奖" Value="0"></asp:ListItem>
                            <asp:ListItem Text="获奖" Value="1"></asp:ListItem>
                        </asp:DropDownList>
					</td>
                    <td>
		...
		<asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC">  
                        ...
                        <td><%#Eval("AddTime") %></td>
						<td>
                            <ul><li><a href="#" onclick="AdminBizControlConfirm('wfmRaceUserAdmin.aspx?action=del&id=<%#Eval("ID") %>');">删除</a></li>
                            </ul>
						</td>
					</tr>
			</ItemTemplate>
