<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmHpclient.aspx.cs" Inherits="Mozart.CMSAdmin.HappyPhoto.wfmHpclient" %>
	...
	<script type="text/javascript">
	    function AddActivity() {
	        $.dialog({
	            ...
	            width: '400px',
	            height: '200px',
	            content: 'url:HappyPhoto/wfmHpclientAdd.aspx',
	            lock: true,
	            close: function () {
	    ...
	    function UpdateCategory(strid) {
	        $.dialog({
	            id: 'wfmHpclientUpdate',
	            title: '修改打印端编码',
	            width: '400px',
	            height: '200px',
	            content: 'url:HappyPhoto/wfmHpclientUpdate.aspx?action=update&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
			...
			<table>
				<tr>
                    ...
                    <td>
                        ...
                        <input type="button" value="添加打印端编码" onclick="AddActivity()" />
                    </td>
				</tr>
			</table>
		</asp:Panel>
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC">   
						...
						<td>
                            ...
                            <a href="#" onclick="AdminBizControlConfirm('wfmHpclientAdmin.aspx?action=del&id=<%#Eval("ID")%>');">删除
                            </a>
						</td>
					</tr>
			</ItemTemplate>
