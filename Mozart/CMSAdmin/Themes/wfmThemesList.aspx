<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmThemesList.aspx.cs" Inherits="Mozart.CMSAdmin.Themes.wfmThemesList" %>
	...
	<script type="text/javascript">
	    function AddActivity() {
	        $.dialog({
	            ...
	            width: '400px',
	            height: '200px',
	            content: 'url:Themes/wfmThemesAdd.aspx',
	            lock: true,
	            close: function () {
	    ...
	    function UpdateCategory(strid) {
	        $.dialog({
	            ...
	            width: '400px',
	            height: '200px',
	            content: 'url:Themes/wfmThemesUpdate.aspx?action=update&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
			...
			<table>
				<tr>
                    ...
                    <td>
                        ...
                        <input type="button" value="添加主题" onclick="AddActivity()" />
                    </td>
				</tr>
			</table>
		</asp:Panel>
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC">   
						...
						<td>
                            ...
                            <a href="#" onclick="AdminBizControlConfirm('wfmThemesAdmin.aspx?action=del&id=<%#Eval("ID")%>');">
                              <asp:Label id="isstate" Text='<%#Eval("isstate") %>' runat="server" />
                            </a>
						</td>
					</tr>
			</ItemTemplate>
