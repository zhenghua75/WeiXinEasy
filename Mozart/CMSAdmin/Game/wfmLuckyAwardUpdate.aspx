<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmLuckyAwardUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.Game.wfmLuckyAwardUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="AwardName" runat="server" Width="800px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">奖项类别：</td>
                        <td align="left">
                            <asp:DropDownList ID="awardsort"  runat="server">
                        </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">中奖个数：</td>
                        <td align="left">
                            <asp:TextBox ID="AwardNum" runat="server"  onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">中奖几率：</td>
                        <td align="left">
                            <asp:TextBox ID="AwardPro" runat="server"  onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
