<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmDCBuildingsUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.DC.wfmDCBuildingsUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="AVEPrice" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">绿化率：</td>
                        <td align="left">
                            <asp:TextBox ID="GreenRate" runat="server" Width="200px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">容积率：</td>
                        <td align="left">
                            <asp:TextBox ID="VolumeRate" runat="server" Width="200px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">周边学校：</td>
                        <td align="left">
                            <asp:TextBox ID="School" runat="server" Width="200px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">停车位：</td>
                        <td align="left">
                            <asp:TextBox ID="ParkingSpaces" runat="server" Width="200px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">开发商：</td>
                        <td align="left">
                            <asp:TextBox ID="PropertyDevelopers" runat="server" Width="200px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">物业公司：</td>
                        <td align="left">
                            <asp:TextBox ID="PropertyCompany" runat="server" Width="200px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">公交路线：</td>
                        <td align="left">
                            <asp:TextBox ID="BusLine" runat="server" Width="200px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">详细地址：</td>
                        <td align="left">
                            <asp:TextBox ID="Address" runat="server" Width="800px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
