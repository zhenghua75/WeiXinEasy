...
{
    public partial class wfmDCHouseList : System.Web.UI.Page
    {
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(this.txtTitle.Text) && txtTitle.Text.Trim() != null && txtTitle.Text.Trim() != "")
            {
                if (strWhere.Trim() != null && strWhere.Trim() != "")
                {
                    strWhere = strWhere + " AND ";
                }
                strWhere = strWhere + "   HouseType LIKE '%" + this.txtTitle.Text + "%' ";
                if (!string.IsNullOrEmpty(this.ddlCategory.SelectedValue) && ddlCategory.SelectedValue.Trim() != "")
                {
                    if (strWhere.Trim() != null && strWhere.Trim() != "")
                    {
                        strWhere = strWhere + " AND ";
                    }
                    strWhere = strWhere + "  SaleRental = '" + ddlCategory.SelectedValue + "' ";
                }
            }
            else 
            {
