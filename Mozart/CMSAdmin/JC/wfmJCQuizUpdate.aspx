<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmJCQuizUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.JC.wfmJCQuizUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="starttime" datatype="*1-50" errormsg="请选择正确的日期"   runat="server" Width="230px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">主队名称：</td>
                        <td align="left">
                            <asp:TextBox ID="hometeam" runat="server" Width="230px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">主队图标：</td>
                        <td align="left">
                            <div style="overflow: hidden;">
                                <input type="file" id="file0" runat="server" />&nbsp;
                            </div>
                            <div>
                                <img src="" id="img0" width="20" height="20" alt="" runat="server" />
                            </div>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="VisitingTeam" runat="server" Width="230px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">客队图标：</td>
                        <td align="left">
                            <div style="overflow: hidden;">
                                <input type="file" id="file1" runat="server" />&nbsp;
                            </div>
                            <div>
                                <img src="" id="img1" width="20" height="20" alt="" runat="server" />
                            </div>
                            <script type="text/javascript">
                    ...
                    <tr>
                        <td align="right">正确比分：</td>
                        <td align="left">
                            <asp:TextBox ID="RightScore" runat="server" Width="230px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
