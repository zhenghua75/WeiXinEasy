<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmMSForumTopicUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmMSForumTopicUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    ...
                    <tr>
                        <td align="right"></td>
                        <td>
                            <asp:Button ID="btnSave" runat="server" Text="保存" OnClientClick="return getContent();" OnClick="btnSave_Click" CssClass="cssbtn" /> 
                            <script type="text/javascript">
                                function getContent() {
