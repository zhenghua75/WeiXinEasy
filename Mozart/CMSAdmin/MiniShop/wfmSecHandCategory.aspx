<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmSecHandCategory.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmSecHandCategory" %>
	...
	<script type="text/javascript">
	    ...
	    function AddFunction() {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:MiniShop/wfmSecHandCategoryAdd.aspx?sch=' + sch,
	            lock: true,
	            close: function () {
	    ...
	    function UpdateArticle(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:MiniShop/wfmSecHandCategoryUpdate.aspx?action=update&id=' + strid + "&sch=" + sch,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
	    ...
	    function ShowArticle(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:MiniShop/wfmSecHandCategoryUpdate.aspx?action=show&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
			...
			<table>
				<tr>
                    ...
                    <td>
                        ...
                        <input type="button" value="添加类别" onclick="AddFunction()" />
                    </td>
				</tr>
			</table>
		</asp:Panel>
					...
					<tr style="background-color:#FAF3DC"> 
						...
						<td>
                            <ul>
                                ...
                                <li><a href="#" onclick="AdminBizControlConfirm('wfmProductCategoryAdmin.aspx?action=del&id=<%#Eval("ID") %>');">删除</a></li>
                            </ul>
						</td>
					</tr>
			</ItemTemplate>
