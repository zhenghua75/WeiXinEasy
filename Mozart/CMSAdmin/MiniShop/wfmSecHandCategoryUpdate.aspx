<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmSecHandCategoryUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmSecHandCategoryUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="sortin" runat="server" MaxLength="5" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
