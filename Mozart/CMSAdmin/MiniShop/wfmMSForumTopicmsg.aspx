<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmMSForumTopicmsg.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmMSForumTopicmsg" %>
					...
					<tr style="background-color:#FAF3DC"> 
						...
						<td>
                            <ul>
                                ...
                                <li><asp:Label Text='<%#Eval("ID")%>' ToolTip='<%#Eval("Review") %>' 
                                        ID="linktreview" runat="server" />&nbsp;|&nbsp;</li>
                                <li>
                                    <a href="#" onclick="AdminBizControlConfirm('wfmMSForumTopicmsgAdmin.aspx?action=del&id=<%#Eval("ID") %>');">删除</a></li>
                            </ul>
						</td>
					</tr>
			</ItemTemplate>
