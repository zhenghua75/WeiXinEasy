...
{
    public partial class wfmProductAtlas : System.Web.UI.Page
    {
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            {
                strWhere = " AND a.[AtlasName] LIKE '%" + txtName.Text + "%' ";
            }
        ...
        void LoadData(string strWhere)
        {
            ...
            DataSet AtlasDs = AtlasDal.GetMSProductAtlasList(strWhere);
            DataView dv = AtlasDs.Tables[0].DefaultView;
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label lb_shoplogo = (Label)e.Item.FindControl("atlas");
