<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmMSShopUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmMSShopUpdate" %>
        ...
        <div style="padding: 20px,0,0,20px;">
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    <tr>
                        <td align="right">选择用户电话：</td>
                        <td align="left">
                            <asp:TextBox ID="userphone" ReadOnly="true" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="wxname" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">微信号：</td>
                        <td align="left">
                            <asp:TextBox ID="wxnum" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">店铺背景：</td>
                        <td align="left">
                            <div style="overflow: hidden;">
                                <input type="file" id="file1" runat="server" />&nbsp;建议尺寸320x145
                            </div>
                            <div>
