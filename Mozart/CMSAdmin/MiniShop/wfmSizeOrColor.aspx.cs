...
{
    public partial class wfmSizeOrColor : System.Web.UI.Page
    {
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            {
                strWhere += " AND c.[ID]='" + ddlshoplist.SelectedValue + 
                    "' AND b.[SID]='" + ddlshoplist.SelectedValue + "' ";
            }
            if (setsortvalue.Value.Trim() != null && setsortvalue.Value.Trim() != "")
            {
                strWhere += " AND d.[ID]='" + setsortvalue.Value +
                                   "' AND b.[CID]='" + setsortvalue.Value + "' ";
            }
            if (setpvalue.Value.Trim() != null && setpvalue.Value.Trim() != "")
            {
                strWhere += " AND a.[PID]='" + setpvalue.Value +
                                                  "' AND b.[ID]='" + setpvalue.Value + "' ";
            }
            if (sizeorcolor.SelectedValue.Trim() != null && sizeorcolor.SelectedValue.Trim() != "")
            {
                strWhere += " AND a.[SizeColor]=" + sizeorcolor.SelectedValue;
            }
            if (txtName.Text.Trim() != null && txtName.Text.Trim() != "")
            {
                strWhere  += " AND a.[Scname] LIKE '%" + txtName.Text + "%' ";
            }
            AspNetPager1.CurrentPageIndex = 1;
        ...
        {
            MSSizeOrColorDAL sizecolorDal = new MSSizeOrColorDAL();
            DataSet ds = sizecolorDal.GetSizeOrColorList(strWhere);
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label lb_scimg= (Label)e.Item.FindControl("scimg");
                if (lb_scimg.Text != null && lb_scimg.Text != "")
                {
                    lb_scimg.Text = "<img src=\"../../PalmShop/ShopCode/" + lb_scimg.Text +
