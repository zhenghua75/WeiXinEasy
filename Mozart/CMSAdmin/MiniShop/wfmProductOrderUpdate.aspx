<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmProductOrderUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmProductOrderUpdate" ValidateRequest="false" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    <tr>
                        ...
                        <td align="left">
                           <asp:TextBox ID="shopname" ReadOnly="true" runat="server" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Label id="payway" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">订单金额：</td>
                        <td align="left">
                            ￥<asp:TextBox ID="UnitCost" runat="server" ></asp:TextBox>元
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Label id="buyname" runat="server" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Label id="ReveiveAddress" runat="server" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="PayTime" runat="server" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
