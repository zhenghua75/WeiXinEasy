<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmMSShopAdd.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmMSShopAdd" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlphonelist" runat="server"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
