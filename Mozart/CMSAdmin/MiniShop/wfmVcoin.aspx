<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmVcoin.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmVcoin" %>
	...
	<script type="text/javascript">
	    function ShowArticle(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:MiniShop/wfmVcoinDetail.aspx?action=show&id=' + strid,
	            lock: true,
	            close: function () {
		...
		<asp:Panel ID="Panel1" runat="server" Height="31px" HorizontalAlign="Center">
			<table>
				<tr>
                    ...
                    <td>注册电话：</td>
					<td>
						<asp:TextBox ID="phone" maxlength="13" runat="server" Width="80px" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" 
		...
		<asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC"> 
						...
						<td>
                            <ul>
                                <li><a href="javascript:" onclick="ShowArticle('<%#Eval("CustID") %>');">详细</a></li>
                            </ul>
						</td>
					</tr>
			</ItemTemplate>
