<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmMSForumTopic.aspx.cs" Inherits="Mozart.CMSAdmin.MiniShop.wfmMSForumTopic" %>
	...
	<script type="text/javascript">
	    function UpdateArticle(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:MiniShop/wfmMSForumTopicUpdate.aspx?action=update&id=' + strid,
	            lock: true,
	            close: function () {
	    ...
	    function ShowArticle(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '600px',
	            content: 'url:MiniShop/wfmMSForumTopicUpdate.aspx?action=show&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
		...
		<asp:Panel ID="Panel1" runat="server" Height="31px" HorizontalAlign="Center">
			<table>
				<tr>
                    ...
                    <td>
						<asp:DropDownList ID="ddlforumlist"  runat="server"></asp:DropDownList>
					</td>
                    <td>
					...
					<tr style="background-color:#FAF3DC"> 
						...
						<td>
                            <ul>
                                ...
                                <li><asp:Label Text='<%#Eval("ID")%>' ToolTip='<%#Eval("Treview") %>' 
                                        ID="linktreview" runat="server" />&nbsp;|&nbsp;</li>
                                <li>
                                    <a href="#" onclick="AdminBizControlConfirm('wfmMSForumTopicAdmin.aspx?action=del&id=<%#Eval("ID") %>');">删除</a>&nbsp;|&nbsp;</li>
                                <li><a href='wfmMSForumTopicmsg.aspx?tid=<%#Eval("ID") %>'>查看消息</a>&nbsp;|&nbsp;</li>
                            </ul>
						</td>
					</tr>
			</ItemTemplate>
