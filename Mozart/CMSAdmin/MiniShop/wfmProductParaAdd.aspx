<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmProductParaAdd.aspx.cs" EnableEventValidation="false" Inherits="Mozart.CMSAdmin.MiniShop.wfmProductParaAdd" %>
    ...
    <script>
        ...
        function GetSortOption(id) {
            ...
            if (value == 0 || value == "0") { }
                ...
                $.getJSON("wfmProductParaAdd.aspx", { "action": "getcateoption", "subid": value }, function (json) {
        ...
        function GetProductOption(id, subid) {
            ...
            if (value == 0 || value == "0") { }
                ...
                $.getJSON("wfmProductParaAdd.aspx", { "action": "getpoption", "subid": subvalue, "catid": value }, function (json) {
                    $.each(json, function (i, item) {
                        var optionID = item.ID;
