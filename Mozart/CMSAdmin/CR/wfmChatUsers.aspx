<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmChatUsers.aspx.cs" Inherits="Mozart.CMSAdmin.CR.wfmChatUsers" %>
		...
		<asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC"> 
						...
						<td>
                            <ul>
                                <li><a href="#" onclick="AdminBizControlConfirm('wfmChatUserAdmin.aspx?action=del&id=<%#Eval("ID") %>');">删除</a></li>
                            </ul>
						</td>
					</tr>
			</ItemTemplate>
