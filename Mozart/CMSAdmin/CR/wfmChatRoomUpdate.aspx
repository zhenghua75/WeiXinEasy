<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmChatRoomUpdate.aspx.cs" ValidateRequest="false" Inherits="Mozart.CMSAdmin.CR.wfmChatRoomUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="RoomNum" ReadOnly="true" runat="server" Width="800px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">名称：</td>
                        <td align="left">
                            <asp:TextBox ID="RoomName" runat="server" Width="800px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">微信号：</td>
                        <td align="left">
                            <asp:TextBox ID="appid" runat="server" Width="800px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <div style="overflow: hidden;">
                                <input type="file" id="file0" runat="server" />&nbsp;建议尺寸1360x760
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="phonenum" runat="server"  onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^0-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
