<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmVotesubjectAdd.aspx.cs" Inherits="Mozart.CMSAdmin.Vote.wfmVotesubjectAdd" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function suboptionlist() {
            var strData = "";
            var list = document.getElementById("MyOption").getElementsByTagName("input");
            //对表单中所有的input进行遍历
            var temp = UE.getEditor('myEditor').getContent();//获取编辑器的内容
            var txtName = document.getElementById("txtName");
            var starttime = document.getElementById("starttime");
            var endtime = document.getElementById("endtime");
            var IsValid = document.getElementById("ValidY").checked ? 1 : 0;
            ...
            if (txtName.value == null || txtName.value == "") {
                ...
                $.getJSON("wfmVotesubjectAdd.aspx" + strData, { "action": "save", "txtName": txtName.value, "Content": temp, "IsValid": IsValid, "BeginTime": starttime.value, "endtime": endtime.value }, function (json) {
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:RadioButton ID="ValidY" GroupName="Valid" Text="是" Checked="true" runat="server" />
                            <asp:RadioButton ID="ValidN" GroupName="Valid" Text="否" runat="server" />
                        </td>
                    </tr>
