<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmKeywordMsgTextRule.aspx.cs" Inherits="Mozart.CMSAdmin.WeiXin.wfmKeywordMsgTextRule" %>
	...
	<script type="text/javascript">
	    function AddFunction() {
	        $.dialog({
	            ...
	            width: '460px',
	            height: '245px',
	            content: 'url:WeiXin/wfmKeywordMsgTextRuleAdd.aspx',
	            lock: true,
	            close: function () {
	    ...
	    function UpdateArticle(strid) {
	        $.dialog({
	            ...
	            width: '460px',
	            height: '245px',
	            content: 'url:WeiXin/wfmKeywordMsgTextRuleUpdate.aspx?action=update&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
	    ...
	    function ShowArticle(strid) {
	        $.dialog({
	            ...
	            width: '460px',
	            height: '245px',
	            content: 'url:WeiXin/wfmKeywordMsgTextRuleUpdate.aspx?action=show&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
			...
			<table>
				<tr>
                    ...
                    <td>
                        ...
                        <input type="button" value="添加关键字回复" onclick="AddFunction()" />
                    </td>
				</tr>
			</table>
		</asp:Panel>
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC">  
						...
						<td>
                            ...
                            <a href="#" onclick="AdminBizControlConfirm('wfmKeywordMsgTextRuleAdmin.aspx?action=del&id=<%#Eval("ID") %>');">删除</a>
						</td>
					</tr>
			</ItemTemplate>
			<FooterTemplate>
