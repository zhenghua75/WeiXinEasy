    ...
    public partial class WXUser : System.Web.UI.Page
    {
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            if (openid.Text.Trim() != null && openid.Text.Trim() != "")
            {
                ...
                strWhere = strWhere + " [OpenID]= '" + openid.Text + "' ";
            }
            if (nickName.Text.Trim() != null && nickName.Text.Trim() != "")
            {
                ...
                strWhere = strWhere + " [NickName] LIKE '%" + nickName.Text + "%' ";
            }
            AspNetPager1.CurrentPageIndex = 1;
        ...
        void LoadData(string strWhere)
        {
            ...
            DataSet ds = dal.GetWXUserListBySiteCode(strWhere);
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label lb_sexin = (Label)e.Item.FindControl("sexin");
                switch (lb_sexin.Text.Trim())
                {
                    case"0":
                    lb_no.Text="女";
                    break;
        ...
        {
            if (Session["strRoleCode"].ToString() != "ADMIN" && Session["strRoleCode"].ToString() != null &&
                Session["strRoleCode"].ToString() != "")
            {
                UserDAL.SyncWXUserBySiteCode(Session["strRoleCode"].ToString());
                Response.Redirect("WXUser.aspx");
            }
        }
    }
}