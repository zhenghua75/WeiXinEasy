<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmCouponList.aspx.cs" Inherits="Mozart.CMSAdmin.Coupon.wfmCouponList" %>
		...
		<asp:Panel ID="Panel1" runat="server" Height="31px" HorizontalAlign="Center">
			<table>
				<tr>
                    ...
                    <td>活动名称：</td>
					<td>
					    <asp:DropDownList ID="ddlsiteactive"  runat="server">
                    ...
                    <td>结束时间：</td>
					<td>
						<asp:TextBox ID="endTime" runat="server" Width="80px"></asp:TextBox>
					</td>
                    <td>
		...
		<asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC">  
						...
						<td><%#DataBinder.Eval(Container.DataItem, "ActTitle")%></td>
                        <td><%#DataBinder.Eval(Container.DataItem, "ActContent")%></td>
                        <td><%#DataBinder.Eval(Container.DataItem, "AddTime")%></td>
                        <td><%#DataBinder.Eval(Container.DataItem, "CheckTime")%></td>
                        <td><%#DataBinder.Eval(Container.DataItem, "CouponStatus")%></td>
						<td>
                            <a href="#" onclick="AdminBizControlConfirm('wfmCouponAdmin.aspx?action=1&id=<%#DataBinder.Eval(Container.DataItem, "ID")%>');">重新打印</a>
						</td>
					</tr>
			</ItemTemplate>
			<FooterTemplate>
