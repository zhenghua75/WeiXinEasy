...
{
    public partial class wfmSiteActivityList : System.Web.UI.Page
    {
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(this.txtTitle.Text) && txtTitle.Text.Trim() != null && txtTitle.Text.Trim()!="")
            {
                ...
                strWhere = strWhere + "  ActTitle LIKE '%" + this.txtTitle.Text + "%' ";
            }
            AspNetPager1.CurrentPageIndex = 1;
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label lb_ActStatus = (Label)e.Item.FindControl("ActStatus");
                switch (lb_isdel.Text.Trim())
                {
                    case "0":
                        lb_isdel.Text = "生效";
                        lb_ActStatus.Text = "失效";
                        break;
                    default:
                        lb_isdel.Text = "失效";
                        lb_ActStatus.Text = "生效";
                        break;
                }
            }
        }
