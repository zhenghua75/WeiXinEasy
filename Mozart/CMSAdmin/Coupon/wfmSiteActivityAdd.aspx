<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmSiteActivityAdd.aspx.cs" Inherits="Mozart.CMSAdmin.Coupon.wfmSiteActivityAdd" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:RadioButton ID="ActStatusyes" GroupName="ActStatus" Text="是" Checked="true" runat="server" />
