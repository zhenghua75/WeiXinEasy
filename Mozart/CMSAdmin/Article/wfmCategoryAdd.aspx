<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmCategoryAdd.aspx.cs" Inherits="Mozart.CMSAdmin.Article.wfmCategoryAdd" %>
			    ...
			    <table style="height: 345px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <div>
                                <img src="" id="img0" width="60" height="60" alt=""/>
                            </div>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtLink" runat="server" Width="800px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right"></td>
                        <td>
                            <asp:Button ID="btnSave" runat="server" Text="保存" OnClick="btnSava_Click" OnClientClick="return getContent();" CssClass="cssbtn" /> 
                            <script type="text/javascript">
                                function getContent() {
						    ...
						    <asp:Button ID="btnReset" runat="server" Text="重置" OnClick="btnResett_Click" />
                        </td>
                    </tr>
                </table>
            </div>
