...
{
    public partial class wfmArticleList : System.Web.UI.Page
    {
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            {
                strWhere = strWhere + " AND a.Title LIKE '%" + this.txtTitle.Text + "%'";
            }
            if (ddlCategory.SelectedValue != "0")
            {
                strWhere = strWhere + " AND a.Category = '" + ddlCategory.SelectedValue + "' ";
            }
            AspNetPager1.CurrentPageIndex = 1;
        ...
        void LoadData(string strWhere)
        {
            ...
            DataSet ds = dal.GetAllArticle(strWhere);
