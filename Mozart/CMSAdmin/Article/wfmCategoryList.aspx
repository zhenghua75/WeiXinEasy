<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmCategoryList.aspx.cs" Inherits="Mozart.CMSAdmin.Article.wfmCategoryList" %>
	...
	<script type="text/javascript">
	    function AddCategory() {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '520px',
	            content: 'url:Article/wfmCategoryAdd.aspx',
	            lock: true,
	            close: function () {
	    ...
	    function UpdateCategory(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '640px',
	            content: 'url:Article/wfmCategoryUpdate.aspx?action=update&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
	    ...
	    function ShowCategory(strid) {
	        $.dialog({
	            ...
	            width: '1000px',
	            height: '640px',
	            content: 'url:Article/wfmCategoryUpdate.aspx?action=show&id=' + strid,
	            lock: true,
	            close: function () {
	                __doPostBack('btnQuery', '');
	            }
			...
			<table>
				<tr>
                    ...
                    <td>
                        ...
                        <input type="button" value="添加文章类别" onclick="AddCategory()" />
                    </td>
				</tr>
			</table>
		</asp:Panel>
		...
		<asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC">   
						...
						<td>
                            <a href="#" onclick="ShowCategory('<%#DataBinder.Eval(Container.DataItem, "ID")%>');">详细内容</a>&nbsp;|&nbsp;
                            <a href="#" onclick="UpdateCategory('<%#DataBinder.Eval(Container.DataItem, "ID")%>');">修改</a>&nbsp;|&nbsp;
                            <a href="#" onclick="AdminBizControlConfirm('wfmCategoryAdmin.aspx?action=del&id=<%#DataBinder.Eval(Container.DataItem, "ID")%>');">删除</a>
						</td>
					</tr>
			</ItemTemplate>
			<FooterTemplate>
