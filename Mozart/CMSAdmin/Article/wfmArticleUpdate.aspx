<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmArticleUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.Article.wfmArticleUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlArticleIsTop" runat="server">
                    ...
                    <tr>
                        ...
                        <td align="left">
                             <asp:TextBox onkeypress="if (event.keyCode < 48 || event.keyCode >57) event.returnValue = false;" ID="txtOrder" runat="server" width="20px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
