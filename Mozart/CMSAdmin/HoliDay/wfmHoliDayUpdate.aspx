<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmHoliDayUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.HoliDay.wfmHoliDayUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="endtime" datatype="*1-50" errormsg="请选择正确的日期"   runat="server" Width="230px" ></asp:TextBox>
                       </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
