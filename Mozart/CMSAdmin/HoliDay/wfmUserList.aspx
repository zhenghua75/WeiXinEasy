<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmUserList.aspx.cs" Inherits="Mozart.CMSAdmin.HoliDay.wfmUserList" %>
		...
		<asp:Panel ID="Panel1" runat="server" Height="31px" HorizontalAlign="Center">
			<table>
				<tr>
                    ...
                    <td>所在节日：</td>
                    <td>
                        <asp:DropDownList ID="ddlHolidayList"  runat="server">
		...
		<asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC"> 
						...
						<td>
                            <ul>
                                <li><a href="#" onclick="AdminBizControlConfirm('wfmUserAdmin.aspx?action=del&id=<%#Eval("ID") %>');">删除</a></li>
                            </ul>
						</td>
					</tr>
			</ItemTemplate>
