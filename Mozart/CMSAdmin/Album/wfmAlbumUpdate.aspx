<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmAlbumUpdate.aspx.cs" Inherits="Mozart.CMSAdmin.Album.wfmAlbumUpdate" %>
		    ...
		    <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
			    <table style="height: 345px">
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="AlbumName" runat="server" Width="800px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlAlbumType" Width="180px" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
