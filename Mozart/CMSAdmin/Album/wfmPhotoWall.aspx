<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmPhotoWall.aspx.cs" Inherits="Mozart.CMSAdmin.Album.wfmPhotoWall" %>
		...
		<asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
			...
			<ItemTemplate>
					<tr style="background-color:#FAF3DC">   
						...
						<td><%#Eval("name")%></td>
                        <td>
                            <img src='../../<%#Eval("FilePath")%>' alt='<%#Eval("name")%>' width="20px" height="20px" />
                        </td>
                        <td><%#Eval("Remark")%></td>
                        <td><%#Eval("AddTime")%></td>
						<td>
                            <asp:Label Text='<%#Eval("ID") %>' CssClass='<%#Eval("state") %>' ID="state" runat="server" />
						</td>
					</tr>
			</ItemTemplate>
			<FooterTemplate>
