...
{
    public partial class wfmPhotoWall : System.Web.UI.Page
    {
        ...
        {
            txtTitle.Text = "";
            PhotoWallDAL dal = new PhotoWallDAL();
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    lb_state.Text = "<a href=\"javascript:\" onclick=\"AdminBizControlConfirm('wfmPhotoWallAdmin.aspx?action=del&id=" + lb_state.Text + ">');\">通过</a>";
                }
            }
        }
