<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmRightManage.aspx.cs" Inherits="Mozart.CMSAdmin.SysAdmin.wfmRightManage" %>
	...
	<form id="form1" runat="server">
        ...
        <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#b5d6e6">
                <tr>
                    <td bgcolor="#FFFFFF" width="30%">角色选择</td>
                    <td bgcolor="#FFFFFF" width="30%">权限列表</td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" width="30%">
                        <asp:DropDownList ID="ddlRole" runat="server" Height="20px" Width="148px"  AutoPostBack="true" OnSelectedIndexChanged="ddlRole_SelectedIndexChanged" ></asp:DropDownList>
                    </td>
                    <td bgcolor="#FFFFFF" width="30%">
