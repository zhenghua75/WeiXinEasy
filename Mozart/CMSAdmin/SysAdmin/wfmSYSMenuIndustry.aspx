<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmSYSMenuIndustry.aspx.cs" Inherits="Mozart.CMSAdmin.SysAdmin.wfmSYSMenuIndustry" %>
	...
	<form id="form1" runat="server">
        ...
        <div style = "background-color:#BED3FE;border:solid 1px #809FB5;">
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#b5d6e6">
                <tr>
                    <td bgcolor="#FFFFFF" width="30%">行业选择</td>
                    <td bgcolor="#FFFFFF" width="30%">菜单列表</td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" width="30%">
                        <asp:DropDownList ID="ddlCategory" runat="server" Height="20px" Width="148px"  AutoPostBack="true" OnSelectedIndexChanged="ddlRole_SelectedIndexChanged" ></asp:DropDownList>
                    </td>
                    <td bgcolor="#FFFFFF" width="30%">
