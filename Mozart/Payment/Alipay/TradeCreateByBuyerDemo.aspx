<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TradeCreateByBuyerDemo.aspx.cs" Inherits="Mozart.Payment.Alipay.TradeCreateByBuyerDemo" %>
            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <asp:TextBox ID="WIDseller_email" name="WIDseller_email" runat="server">1228855790@qq.com</asp:TextBox>
                        <span>必填</span>
                    </dd>
                    <dt>商户订单号：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDprice" name="WIDprice" runat="server"></asp:TextBox>
                        <span>必填</span>
                    </dd>
                    <dt>订单描述：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="new-btn-login-sp">
                            <asp:Button ID="BtnAlipay" name="BtnAlipay" Text="确 认" 
