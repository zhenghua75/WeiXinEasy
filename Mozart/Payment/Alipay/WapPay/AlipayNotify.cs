...
namespace Mozart.Payment.Alipay.WapPay
{
    ...
    public class AlipayNotify
    {
        ...
        public AlipayNotify()
        {
            ...
            _public_key = AlipayConfig.Public_key;
        ...
        public bool VerifyReturn(Dictionary<string, string> inputPara, string sign)
        {
            bool isSign = false;
                //获取返回时的签名验证结果
            isSign = GetSignVeryfy(inputPara, sign, true);
        ...
        public Dictionary<string, string> Decrypt(Dictionary<string, string> inputPara)
        {
            try
            {
                inputPara["notify_data"] = AlipayRSAFromPkcs8.decryptData(inputPara["notify_data"], _private_key, _input_charset);
            }
            catch (Exception e) { }
