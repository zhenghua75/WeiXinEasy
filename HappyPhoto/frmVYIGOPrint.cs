...
{
    public partial class frmVYIGOPrint : Form
    {
        [DllImport("wininet")]
        ...
        private void frmVYIGOPrint_Load(object sender, EventArgs e)
        {
        ...
        void printDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(strAttachText))
            {
                ...
                e.Graphics.DrawString(CutStr(strAttachText, 11), printFont, printColor,80, 350);
            }
            //微信扫我
            var codeimgfont = new Font("宋体", 9, System.Drawing.FontStyle.Regular);
            var codeimgColor = System.Drawing.Brushes.Black;
            e.Graphics.DrawString(CutStr("微信扫我\r\n", 1), codeimgfont, codeimgColor, -2, 335);
            //打印公司图标
            Image footImage = Image.FromFile(Application.StartupPath + "\\log.jpg");
            e.Graphics.DrawImage(footImage, 12, 326);
